...
function () {
  function UserForm(parent, model) {
    ...
    this.onSetNameClick = function () {
      ...
      if (name === '') {
        ...
        div.innerHTML = "<p> Name cannot be empty</p>";
  ...
  UserForm.prototype.render = function () {
    // empty up the parent element everytime re-render
...
function () {
  function Model(attributes, events, sync) {
    ...
    // 	// return a reference of 'on' method
...
var axios_1 = __importDefault(require("axios")); // passing two args (K specifies json style)
